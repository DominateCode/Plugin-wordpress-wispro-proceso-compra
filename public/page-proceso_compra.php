        ...
        <div class="row row-cols-1 row-cols-md-3 g-5">
          <div class="col">
            <div class="card br-2">
              <div class="card-header text-center fw-bold color-primario-bg color-title"
                ...
                <h4 class="fw-bold">25 Megas</h4>
              </div>
              <div class="card-body">
                <p class="m-0 text-center BwSurcoDemo-Regular">Hasta 5 dispositivos</p>
                <p class="m-0 text-center color-secundario montserrat-extrabold fs-2">
                  Pregúntanos</p>
                <p class="m-0 text-center BwSurcoDemo-Regular">Estrato 1, 2, y 3</p>
                ...
                <a href="" target="_blank"
                  class="btn color-primario-bg text-white mb-2 BwSurcoDemo-Regular w-75 mx-auto d-block">
                  ...
                  </svg> Compra en linea</a>
                <p class="text-center BwSurcoDemo-Regular">
                  <small class="text-muted"><a href="#modal25megas" data-bs-toggle="modal"
          ...
          <div class="col">
            <div class="card br-2">
              <div class="card-header text-center fw-bold color-primario-bg color-title"
                style="border-top-left-radius: 2rem !important; border-top-right-radius: 2rem !important; ">
                <h4 class="fw-bold">35 Megas</h4>
              </div>
              <div class="card-body">
                <p class="m-0 text-center BwSurcoDemo-Regular">Hasta 8 dispositivos</p>
                <p class="m-0 text-center color-secundario montserrat-extrabold fs-2">
                  Pregúntanos</p>
                <p class="m-0 text-center BwSurcoDemo-Regular">Estrato 1, 2, y 3</p>
                <p class="m-0 text-center BwSurcoDemo-Regular">Instalaciòn en 24 horas</p>
                <a href="http://wa.me/number" target="_blank"
                  class="btn color-terciario-bg mb-2 BwSurcoDemo-Regular  w-75 mx-auto d-block">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <a href="" target="_blank"
                  class="btn color-primario-bg text-white BwSurcoDemo-Regular  w-75 mx-auto d-block"><svg
                ...
                <p class="text-center BwSurcoDemo-Regular">
                  <small class="text-muted"><a href="#modal35megas" data-bs-toggle="modal"
                      data-bs-target="#modal35megas">Más especificaciones</a></small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card br-2">
              <div class="card-header text-center fw-bold color-primario-bg color-title" style="border-top-left-radius: 2rem !important; border-top-right-radius: 2rem !important; ">
                <h3>50 Megas</h3>
              </div>
              <div class="card-body">
                <p class="m-0 text-center BwSurcoDemo-Regular">Hasta 10 dispositivos</p>
                <p class="m-0 text-center color-secundario montserrat-extrabold fs-2">
                  Pregúntanos</p>
                <p class="m-0 text-center BwSurcoDemo-Regular">Estrato 1, 2, y 3</p>
                <p class="m-0 text-center BwSurcoDemo-Regular">Instalación en 24 horas</p>
                ...
                <a href="#" target="_blank"
                  class="btn color-primario-bg text-white BwSurcoDemo-Regular w-75 mx-auto d-block">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="bi bi-cart-fill text-white" viewBox="0 0 16 16">
                    <path
                      d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z">
                ...
                <p class="text-center BwSurcoDemo-Regular">
                  <small class="text-muted"><a href="#modal50megas" data-bs-toggle="modal"
                      data-bs-target="#modal50megas">Más especificaciones</a></small>
                </p>
              </div>
            </div>
          </div>
