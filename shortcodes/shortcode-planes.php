            ...
            foreach ($planes as $plan) {
                ...
                echo     '<div class="card-header text-center fw-bold color-primario-bg color-title"
                    ...
                    <div class="card-body">
                      ...
                      <a href="'.get_site_url().'?p='.get_option('wisprointegration_pagina_proceso_compras') .'" class="btn color-primario-bg text-white mb-2 BwSurcoDemo-Regular w-75 mx-auto d-block">
